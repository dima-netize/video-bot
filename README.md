...
## Швидкий запуск на вже існуючому VPS (по SSH)

Якщо VPS вже є (наприклад `178.197.199.106`, user `Dima`), виконай локально:
...
Після завершення сайт буде доступний на `http://<IP_VPS>`.
